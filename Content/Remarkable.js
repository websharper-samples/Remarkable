...
{
 "use strict";
 var Global,Samples,HelloWorld,SC$1,WebSharper,Obj,UI,Var$1,Operators,HtmlModule,attr,Var,ConcreteVar,Snap,Doc,JavaScript,Pervasives,AttrProxy,AttrModule,Client,Templates,Abbrev,Fresh,View,DomUtility,Seq,Attrs,EventTarget,Node,JS,Collections,Dictionary,Unchecked,Enumerator,T,DynamicAttrNode,SC$2,Arrays,HashSet,WindowOrWorkerGlobalScope,SC$3,Docs,SC$4,Elt,Array,DocElemNode,CharacterData,DictionaryUtil,Object,Prepare,Slice,KeyCollection,An,Settings,Mailbox,Updates,List,T$1,Attrs$1,Dyn,Strings,Docs$1,RunState,NodeSet,Anims,SC$5,SC$6,SC$7,Concurrency,AppendList,Easing,AsyncBody,SC$8,CT,HashSet$1,HashSetUtil,Scheduler,CancellationTokenSource,DomNodes,Queue,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,PR,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 Samples=Global.Samples=Global.Samples||{};
 HelloWorld=Samples.HelloWorld=Samples.HelloWorld||{};
 SC$1=Global.StartupCode$Remarkable$Client=Global.StartupCode$Remarkable$Client||{};
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.Main=(Md=new Global.Remarkable((r={},r.linkify=true,r.typographer=true,r.langPrefix="prettyprint linenums lang-",r)),(rvInput=Var$1.Create$1("```fsharp\nlet x = 0\nlet f a = a*2\nf x\n```"),(a=Doc.Element("div",[],[Doc.Element("p",[],[Doc.TextNode("Type markdown text here:")]),Doc.InputArea([AttrProxy.Create("class","input"),AttrProxy.Create("rows","20"),AttrProxy.Create("value","# Hello world!")],rvInput),Doc.Element("hr",[],[]),Doc.Element("h4",[],[Doc.TextNode("Result")]),Doc.Element("div",[AttrProxy.Create("id","output"),AttrProxy.Create("class","output"),AttrModule.DynamicCustom(function()
  {
   return function(v)
   {
    var _this,a$1;
    _this=Global.jQuery("#output").empty();
    a$1=Md.render(v);
    _this.append.apply(_this,[a$1]);
    return PR.prettyPrint();
   };
  },rvInput.get_View())],[])]),(Templates.LoadLocalTemplates(""),Doc.RunById("main",a)))));
 };
